    ...
    <fieldset>
     ...
     <ul>
      <li><label for="db-server">database server name</label>
       <input id="db-server" name="db_server" type="text" value="[%InstServerName%]"></li>
      <li><label for="db-name">database name</label>
       <input id="db-name" name="db_name" type="text" value="[%InstDBName%]"></li>
      <li><label for="db-user">user name</label>
       <input id="db-user" name="db_user" type="text" value="[%InstDBUser%]"></li>
