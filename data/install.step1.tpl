    ...
    <fieldset>
     ...
     <ul>
      <li><label for="db-server">database server name</label>
       <input id="db-server" name="db_server" type="text" value=""></li>
      <li><label for="db-name">database name</label>
       <input id="db-name" name="db_name" type="text" value=""></li>
      <li><label for="db-user">user name</label>
       <input id="db-user" name="db_user" type="text" value=""></li>
      <li><label for="db-pass">user password</label>
       <input id="db-pass" name="db_pass" type="password" value=""></li>
     </ul>
    </fieldset>
   </form>
